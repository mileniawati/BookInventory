...
public class BookFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            editBookTittle.setText(book.getBook_tittle());
            editGenre.setText(book.getBook_genre());
            editSynopsis.setText(book.getBook_synopsis());
            btnSave.setEnabled(false);
            getSupportActionBar().setTitle(book.getBook_tittle());
        } else {
            //buku baru
            book = new Book();
        }
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    ...
                    book.setBook_tittle(editBookTittle.getText().toString());
